...
import { _ as __nuxt_component_1, d as data } from './blog-89ca4f0e.mjs';
import { _ as _export_sfc, a as __nuxt_component_2$1 } from './server.mjs';
import { _ as __nuxt_component_1$1 } from './CtaThree-da488cf3.mjs';
import { mergeProps, withCtx, createTextVNode, createVNode, useSSRContext } from 'file:///Users/asafebymarques/Downloads/26837132-mitech-vue-nuxt-js-technology-blog-template/mitech-v1.0.7/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderStyle } from 'file:///Users/asafebymarques/Downloads/26837132-mitech-vue-nuxt-js-technology-blog-template/mitech-v1.0.7/node_modules/vue/server-renderer/index.mjs';
...
const _imports_0 = "" + publicAssetsURL("images/blog/blog-03-1170x600.jpg");
const _sfc_main = {
  components: {
    Header: __nuxt_component_0$1,
    Breadcrumbs: __nuxt_component_1,
    CtaThree: __nuxt_component_1$1,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_CtaThree = __nuxt_component_1$1;
  ...
  _push(`<div class="blog-pages-wrapper section-space--ptb_100"><div class="container"><div class="row"><div class="col-lg-12"><div class="post-feature blog-thumbnail wow move-up"><img class="img-fluid"${ssrRenderAttr("src", _imports_0)} alt="Blog Images"></div></div><div class="col-lg-8 ms-auto me-auto"><div class="main-blog-wrap"><div class="single-blog-item wow move-up"><div class="post-info lg-blog-post-info"><div class="post-categories text-center">`);
  _push(ssrRenderComponent(_component_nuxt_link, { to: "/blog" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`SUCCESS STORY, TIPS`);
      } else {
        return [
          createTextVNode("SUCCESS STORY, TIPS")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</div><h3 class="post-title text-center"> How Technology Made Businesses More Efficient </h3><div class="post-meta mt-20 justify-content-center"><div class="post-author">`);
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="single-blog__item"${_scopeId}><div class="single-valid__thum" style="${ssrRenderStyle({ backgroundImage: `url('/images/blog/blog-03-370x120.jpg')` })}"${_scopeId}></div><div class="post-content"${_scopeId}><h6 class="post-title font-weight--bold"${_scopeId}> Designers\u2019 Identities &amp; Social Unconscious Bias </h6></div></div>`);
      } else {
        return [
          createVNode("div", { class: "single-blog__item" }, [
            createVNode("div", {
              class: "single-valid__thum",
  ...
  _push(ssrRenderComponent(_component_nuxt_link, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="single-blog__item"${_scopeId}><div class="single-valid__thum" style="${ssrRenderStyle({ backgroundImage: `url('/images/blog/blog-05-370x120.jpg')` })}"${_scopeId}></div><div class="post-content"${_scopeId}><h6 class="post-title font-weight--bold"${_scopeId}> Designers\u2019 Identities &amp; Social Unconscious Bias </h6></div></div>`);
      } else {
        return [
          createVNode("div", { class: "single-blog__item" }, [
            createVNode("div", {
...
//# sourceMappingURL=blog-details-e0dd5323.mjs.map
